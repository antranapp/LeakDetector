...
class RxSwiftRootViewController: LeakDetectableTableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            ...
            switch scenario {
            case .observable1:
                let viewController = RxSwiftViewController1()
                viewController.title = scenario.rawValue
                weakViewController = viewController
                navigationController?.pushViewController(viewController, animated: true)
            case .observable2:
                let viewController = RxSwiftViewController2()
                viewController.title = scenario.rawValue
                weakViewController = viewController
                navigationController?.pushViewController(viewController, animated: true)
            }
        case 1:
            ...
            case .observable1:
                ...
                navigationController?.pushViewController(viewController, animated: true)
            case .observable2:
                let viewController = NoLeakRxSwiftViewController2()
                viewController.title = scenario.rawValue
                weakViewController = viewController
                navigationController?.pushViewController(viewController, animated: true)
            }
